...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        activate_modules('project_stock')
        ...
        employee.save()
        self.assertEqual(employee.cost_price, Decimal('10.00'))
        ...
        self.assertEqual(project.list_price, Decimal('20.0000'))
        ...
        self.assertEqual(task.list_price, Decimal('20.0000'))
        ...
        self.assertEqual(project.revenue, Decimal('120.00'))
        self.assertEqual(task.revenue, Decimal('100.00'))
        self.assertEqual(task_no_effort.revenue, Decimal('0'))
        self.assertEqual(project.cost, Decimal('0.00'))
        self.assertEqual(task.cost, Decimal('0.00'))
        self.assertEqual(task_no_effort.cost, Decimal('0.00'))
        ...
        self.assertEqual(task.revenue, Decimal('100.00'))
        self.assertEqual(task_no_effort.revenue, Decimal('0'))
        self.assertEqual(project.cost, Decimal('50.00'))
        self.assertEqual(task.cost, Decimal('30.00'))
        self.assertEqual(task_no_effort.cost, Decimal('0.00'))
        ...
        project.reload()
        task.reload()
        self.assertEqual(project.cost, Decimal('75.00'))
        self.assertEqual(task.cost, Decimal('55.00'))
